...
def  helloCallBack():
    room = num1Entry.get()
    cap = int(num2Entry.get())
    Name = num3Entry.get()
    number = int(num4Entry.get())
    main(room, cap,Name,number)


frame = Tk()
frame.title("Scheduling Timetable System")
frame.configure(bg='lightgreen')
frame.minsize(980, 600)
num1 = Label(text="Rooms\n",
             font=("Italic", 16), bg='lightgreen')
num1.pack()
num1Entry = Entry()
num1Entry.place(relx=0.6, rely=0.4, anchor='ne')
num1Entry.pack()
...
num2 = Label(text="Room Capacity\n", font=("Italic", 16), bg='lightgreen')
num2.pack()
num2Entry = Entry()
num2Entry.pack()

num3 = Label(text="Instructor Names\n", font=("Italic", 16), bg='lightgreen')
num3.pack()
num3Entry = Entry()
num3Entry.pack()

num4 = Label(text="Instructor_ID\n", font=("Italic", 16), bg='lightgreen')
num4.pack()
num4Entry = Entry()
num4Entry.pack()

but = Button(text="Generate Timetable", font=("Arial", 14), bg='green', command = helloCallBack)
but.pack()



text = Text(frame, width=122, height=15)
text.insert(END, "")
text.pack()

def main(room, cap,Name,number):
...
#and genrationNumber < 5
    while (population.get_schedules()[0].get_fitness() != 1.0 and genrationNumber < 20):
        genrationNumber += 1
        print("\n> Generation # " + str(genrationNumber))
